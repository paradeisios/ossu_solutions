...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        lowercase_dict = {
            key: string.ascii_lowercase[ii + shift]
            if ii + shift < len(string.ascii_lowercase)
            else string.ascii_lowercase[shift - (len(string.ascii_lowercase) - ii)]
            for ii, key in enumerate(string.ascii_lowercase)
        }
        uppercase_dict = {
            key: string.ascii_uppercase[ii + shift]
            if ii + shift < len(string.ascii_lowercase)
            else string.ascii_uppercase[shift - (len(string.ascii_lowercase) - ii)]
            for ii, key in enumerate(string.ascii_uppercase)
        }
